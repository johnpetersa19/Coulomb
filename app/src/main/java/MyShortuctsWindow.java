...
public class MyShortuctsWindow extends Window{
    ...
    MyShortuctsWindow(ApplicationWindow parent){
        ...
        this.setTitle("Atalhos");
        this.setTitlebar(headerBar);

        headerBar.setShowTitleButtons(true);
        headerBar.addCssClass("plano");
        ...
        generalShortcuts.append(title("Comandos"));
        generalShortcuts.append(box1);

        devciesShortcuts.append(title("Dispositivos"));
...
*/  
    ...
    public void addShortcuts(){
        addCommand(new Widget[]{cardedLabel("Esc")}, label("Ferramenta de mão"));
        addCommand(new Widget[]{cardedLabel("Ctrl") , cardedLabel("A")}, label("Selecionar tudo"));
        addCommand(new Widget[]{cardedLabel("Delete")}, label("Excluir"));
        addCommand(new Widget[]{cardedLabel("Ctrl") , cardedLabel("Drag")}, label("Mover tudo"));
        addCommand(new Widget[]{cardedLabel("Scroll")}, label("Aumentar/diminuir o zoom"));
        addCommand(new Widget[]{cardedLabel("Double Click")}, label("Osciloscópio aberto"));

        addDevice(new Widget[]{cardedLabel("B")}, label("Bateria"));
        addDevice(new Widget[]{cardedLabel("I")}, label("Fonte atual"));
        addDevice(new Widget[]{cardedLabel("R")}, label("Resistência"));
        addDevice(new Widget[]{cardedLabel("C")}, label("Capacitor"));
        addDevice(new Widget[]{cardedLabel("L")}, label("Indutor"));
        addDevice(new Widget[]{cardedLabel("S")}, label("Trocar"));
        addDevice(new Widget[]{cardedLabel("W")}, label("Arame"));
        addDevice(new Widget[]{cardedLabel("V")}, label("Fonte de tensão CA"));
        addDevice(new Widget[]{cardedLabel("D")}, label("Diodo"));
        addDevice(new Widget[]{cardedLabel("Z")}, label("Diodo Zener"));
    }

    Label cardedLabel(String str){
        Label label = label(str);
        label.addCssClass("meu atalho");
